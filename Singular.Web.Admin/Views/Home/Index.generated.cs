...
Write(Html.EmbeddedInclude<NgViewController>(SingularAdminResources.NORMALIZE_CSS, IncludeType.Stylesheet));
...
Write(Html.EmbeddedInclude<NgViewController>(SingularAdminResources.SG_CONTROLS_CSS_MIN, IncludeType.Stylesheet));
...
Write(Html.EmbeddedInclude<NgViewController>(SingularAdminResources.SG_MIN_CSS, IncludeType.Stylesheet));
...
WriteLiteral(@"
    ...
    <body ng-app=""Singular.Application"">
        <header ng-controller=""headerController"">
            <h1><span class=""hidden"">Singular CMS</span>[Logo]</h1>
...
WriteLiteral("\r\n\r\n        <!-- SG CONTROLS -->\r\n        ");
    ...
    Write(Html.EmbeddedInclude<NgViewController>(SingularAdminResources.SG_ROUTE_MIN_JS, IncludeType.JavaScript));
...
WriteLiteral("\r\n        ");
    ...
    Write(Html.EmbeddedInclude<NgViewController>(SingularAdminResources.SG_ELEMENTS_MIN_JS, IncludeType.JavaScript));
...
WriteLiteral("\r\n\r\n        <!-- CONTROLLERS -->\r\n        ");
    ...
    Write(Html.EmbeddedInclude<NgViewController>(SingularAdminResources.HEADER_CONTROLLER_MIN_JS, IncludeType.JavaScript));
